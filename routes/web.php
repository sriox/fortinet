...
Route::group(['middleware' => 'auth', 'prefix' => 'activityTypes'], function(){
    Route::get('/', [
...
Route::group(['middleware' => 'auth', 'prefix' => 'countries'], function(){
    Route::get('/', [
...
Route::group(['middleware' => 'auth', 'prefix' => 'technologies'], function(){
    Route::get('/', [
...
Route::group(['middleware' => 'auth', 'prefix' => 'se'], function(){
    Route::get('/', [
